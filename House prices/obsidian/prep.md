...
- [x] Flag GarageYrBlt -> have_garage, так же нужно учитывать GarageArea, GarageCars | не дропая GarageYrBlt заполнить допустим 'unknown'
...
- [x] так же не стоит забывать про 2 этажи, можно попробовать сделать flag: have_second_floor
- [x] можно сделать flag с ремонтом домов и old_house.
...
- [x] сделать flag: have_pool | **PoolArea** **PoolQC**
